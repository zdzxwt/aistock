...
def call_doubao_api(prompt, model_prefix="doubao-seed-2-0-pro"):
    ...
    # 模型名称格式: doubao-seed-2-0-pro-260215
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return f"API 404错误: 模型 {model} 不存在"
...
def main():
    ...
    with st.sidebar:
        ...
        if st.button("🔧 测试API连接"):
            test_result = call_doubao_api("你好，请回复test", model_choice)
            st.text_area("API测试结果", test_result, height=150)
